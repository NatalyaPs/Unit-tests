...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        // Проверка ожидаемого исключения, с использованием утверждений AssertJ:
        // assertThatThrownBy((double purchaseAmount, int discountAmount) ->
        //         seminars.first.Calculator.Calculator.calculatingDiscount(-100, 10)).isInstanceOf(ArithmeticException.class);

        // assertThatThrownBy((double purchaseAmount, int discountAmount) ->
        //         seminars.first.Calculator.Calculator.calculatingDiscount(100, -10)).isInstanceOf(ArithmeticException.class);      
                
        // assertThatThrownBy((double purchaseAmount, int discountAmount) ->
        //         seminars.first.Calculator.Calculator.calculatingDiscount(100, 110)).isInstanceOf(ArithmeticException.class);
    // }
}