...
//    }
    ...
    //  ПРОМЕЖУТОЧНАЯ ЗАДАЧА семинар-3 ПО УЛУЧШЕНИЮ ТЕСТА ИЗ ПРЕДЫДУЩЕЙ ДЗ в файле CalculatorTest
    // =============================================================
    // 3.3
    ...
    // здесь сделать по аналогии : через @ParameterizedTest и @CsvSource
    @Test
